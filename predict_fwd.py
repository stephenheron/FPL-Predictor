...
from train_fwd_xgb import build_features, get_feature_columns


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate FWD predictions using saved model.")
    parser.add_argument(
        "--input-file",
