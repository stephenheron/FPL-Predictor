...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="Train FWD XGBoost model with walk-forward CV.")
    parser.add_argument(
        "--train-files",
        nargs="+",
        default=[
    ...
    parser.add_argument("--position", default="FWD")
    ...
    parser.add_argument("--importance-out", default="feature_importance_fwd.csv")
    parser.add_argument("--model-out", default="xgb_fwd_model.json")
