...
DEFAULTS = {
    ...
    "patience": 6,
    "random_state": 42,
    "model_out": "lstm_fwd_model.pt",
    "scaler_out": "lstm_fwd_scaler.pkl",
    "report_out": "lstm_fwd_training_report.csv",
    "train_full": False,
}
...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="Train FWD LSTM model.")
