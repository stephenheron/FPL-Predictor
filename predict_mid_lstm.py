...
from train_mid_lstm import LSTMRegressor, build_features, get_feature_columns


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate MID predictions using LSTM model.")
    parser.add_argument(
        "--input-file",
    ...
    parser.add_argument(
        "--model-file",
        default="lstm_mid_model.pt",
        help="Saved LSTM model file.",
    )
    parser.add_argument(
        "--scaler-file",
        default="lstm_mid_scaler.pkl",
    ...
    parser.add_argument(
        "--output-file",
        default="mid_predictions_lstm.csv",
